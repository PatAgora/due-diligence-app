...
**Frontend Login URL**: https://5174-ihzqwl5fhfcbjidc9trwd-c81df28e.sandbox.novita.ai
...
|-------|------|------|-------|
| TeamLead@scrutinise.co.uk | TeamLead | team_lead_1 | 1 |
...
- **Team Leader dashboard path**: `/team_leader_dashboard`
...
curl -X POST https://5050-ihzqwl5fhfcbjidc9trwd-c81df28e.sandbox.novita.ai/login \
  ...
  -d "email=teamlead@scrutinise.co.uk&password=teamlead123"
```

---
*Generated: 2025-12-19*
*Backend: Port 5050 | Frontend: Port 5174*
