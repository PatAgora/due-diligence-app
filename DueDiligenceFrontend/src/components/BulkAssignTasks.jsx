...
function BulkAssignTasks() {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`${BASE_URL}/api/assign_tasks_bulk`, {
        credentials: 'include',
      ...
      setSelectedLevel(data.selected_level || '1');
    } catch (err) {
  ...
  return (
    <BaseLayout>
      <div className="container my-4">
        <div className="mb-4">
          <h2 className="mb-0">Bulk Assign Tasks</h2>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div className="row">
                        ...
                        <div className="d-flex justify-content-between align-items-center">
                          <div className="d-flex align-items-center">
                            ...
                            <div>
                              ...
                              <br />
                              <small className="text-muted">
                                Open Tasks: {reviewer.open_tasks || 0}
                              </small>
                            </div>
                          </div>
            ...
            <div className="col-md-6">
              ...
              <div className="mb-3">
                <label className="form-label">Task Level</label>
                <input
                  type="text"
                  className="form-control"
